...
al_unc=AlExperiment(X,y,model=RandomForestClassifier(n_estimators=100),performance_metric='accuracy_score',stopping_criteria='num_of_queries', stopping_value=stop)
...
al_qbc=AlExperiment(X,y,model=RandomForestClassifier(n_estimators=100),performance_metric='accuracy_score',stopping_criteria='num_of_queries', stopping_value=stop)
...
al_rndm=AlExperiment(X,y,model=RandomForestClassifier(n_estimators=100),performance_metric='accuracy_score',stopping_criteria='num_of_queries', stopping_value=stop)
