...
for index,row in alerts.iterrows():
    ...
    if alertpath not in indexmap:
        ...
        if tool=='Clang':
            data.append({'Severity':severity,'CWE':cwe,'Clang Alert':1,'CodeSonar Alert':0,'Clang Rule':rule,'CodeSonar Rule':'N/A','Line':line,'True Positive':positive})
        elif tool=='gt-csonar':
            data.append({'Severity':'N/A','CWE':'N/A','Clang Alert':0,'CodeSonar Alert':1,'Clang Rule':'N/A','CodeSonar Rule':rule,'Line':line,'True Positive':positive})
